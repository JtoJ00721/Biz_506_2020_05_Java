 ...
 * 클래스에 진입점 메서드를 생성하여야 코드를 실행해볼수 있게 된다.
 * 클래스만 작성된 상태에서는 진입 method가 없으면 스스로 아무런 코드도 실행할 수 없다.
 */
public class MemberEx {
	...
	public static void main(String args[]) {
		...
		System.out.println("두 변수의 덧셈 결과" + (num1 + num2));
		
		System.out.println("두 변수의 덧셈 결과" + sum);
