...
public class Grade_02 {
	...
	public static void main(String[] args) {
		...
		//rnd : 인스턴스, 객체 라고 부른다.
		// 변수이면서 일반적인 다른 변수와는 다른 성질을 갖는다.
		Random rnd = new Random();
		
		// 점, Dot (.) 연산을 사용하여 또다른 기능의 명령어를 연결하고
		// 명령문을 이룰 수 있다.
		
		// 아래의 명령문은 아무일도 수행하지 않는 것처럼 보이지만 
		// 실제로는 무언가 기능을 수행하게 된다.
		// 이 명령문은 Consolㄷ에 표시하는 기능이 없기 때문에 
		// 수행된 결과를 확인할수 없을 뿐이다.
