...
public class ClassEx_02 {
	...
	public static void main(String[] args) {
		...
		//인스턴스를 통해서 변수에 밧을 저장하거나
		//값을 읽을 수 있다.
		//맴버변수에 private 키워드가 있으면
		//인스턴스를 통해서 변수에 접근할 수 없다
		
		//맴벼변수에 접근제한자를 붙이지 않으면
		//클래스가 저장된 패키지에 따라
		//public으로 인식되기도 하고, private로 인식되기도 한다.
		//서로다른 패키지에서는 private으로 인식된다.
