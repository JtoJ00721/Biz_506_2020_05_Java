...
public class WordGameServiceV3 extends WordGameServiceImplV1 {

	/*
	 * List, ArrayList 와 같은 클래스류를 Collection이라고 한다
	 * 다수의 데이터를 담을 수 있는 클래스들이며 VO들ㅇ르 담아서 연산을 수행하는 
	 * 목적으로 사용한다.
	 * 
	...
	public void playGame() {
		...
		while(true) {
			...
			// VO에서 영단어를 추루하여 split()으로 분해한 후 words배열에 담기
			String[] words = wordVO.getEng().split("");
			List<String> wordList = Arrays.asList(words);
			Collections.shuffle(wordList);
			
			System.out.println("다음 알파벳을 단어 순서에 맞게 나열하시오");
