 ...
 * 그 중 일부 메서드를 나만의 코드로 바꾸어서 사용하고 싶을 때
...
public class ScoreServiceImplV2 extends ScoreServiceImplV1 {
	...
	/*
	 * 이곳에는 보이지는 않지만 ScoreServiceImplV1의 모든 기능(필드변수, 메서드)이 복사 붙이기 되어 있는 것과 같다.
	 * extends ScoreServiceImpl1 명령문을 클래스 위에 붙였기 때문이다.
	 */

	/*
	 * ScoreServiceImplV1의 모든 기능중 scoreList() method의 코드를 바꾸어서 작성하고 싶다. 단, 나머지 기능은
	 * V1의 것을 사용하고 싶다.
	 */
	@Override
